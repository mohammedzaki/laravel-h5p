...
namespace Zaki\LaravelH5p;

use Zaki\LaravelH5p\Commands\MigrationCommand;
use Zaki\LaravelH5p\Commands\ResetCommand;
...
class LaravelH5pServiceProvider extends \Illuminate\Support\ServiceProvider
{
     ...
     */
    protected $listen = [
        'Zaki\LaravelH5p\Events\H5pEvent' => [
            'Zaki\LaravelH5p\Listeners\H5pNotification',
        ],
    ];
